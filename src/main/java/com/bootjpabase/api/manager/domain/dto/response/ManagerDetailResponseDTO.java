...
public class ManagerDetailResponseDTO implements Serializable {
    ...
    @Schema(description = "관리자등급코드 목록")
    private List<CodeNameListResponseDTO> roleCodeList;
    ...
    @QueryProjection
    public ManagerDetailResponseDTO(String id, String name, String phone, String email, String roleCode, String roleCodeName, String regUser, LocalDateTime regDt) {
        this.id = id;
        this.name = name;
        this.phone = phone;
        this.email = email;
